...
namespace Weak.AurasPlugin
{
    ...
    {
        private const string EndPoint = @"https://api.github.com/repos/billyvg/ACT_AurasPlugin/releases/latest";
        ...
        public static string Check()
        {
            ...
            try
            {
                ...
                {
                    wc.Headers.Add("User-Agent", @"ACT AurasPlugin UpdateChecker/1.0; using .NET WebClient/4.0.0");

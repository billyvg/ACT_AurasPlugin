...
{
    public partial class AurasOverlayConfigPanel : UserControl
    {
        private AurasOverlay overlay;
        private AurasOverlayConfig config;

        public AurasOverlayConfigPanel(AurasOverlay overlay)
        {
            InitializeComponent();
